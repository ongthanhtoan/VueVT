      ...
      <b-row>
        <b-colxx xxs="12">
          ...
          <div class="top-right-button-container">
            ...
            <b-modal id="modalright" ref="modalright" :title="$t('khachhang.add-new-modal-title')" modal-class="modal-right t">
              <b-form>
                <b-form-group :label="$t('khachhang.ma')">
                  <b-form-input v-model="newItem.title" />
                </b-form-group>
                <b-form-group :label="$t('khachhang.ten')">
                  <b-form-input v-model="newItem.title" />
                </b-form-group>
                <b-form-group :label="$t('khachhang.loai')">
