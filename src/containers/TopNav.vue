    ...
    <div class="navbar-right">
        ...
        <div class="user d-inline-block">
            <b-dropdown class="dropdown-menu-right" right variant="empty" toggle-class="p-0" menu-class="mt-3" no-caret>
                <template slot="button-content">
                    <span v-if="currentUser.displayName" class="name mr-1">{{currentUser.displayName}}</span>
                    <span>
                        <img v-if="currentUser.displayName" :alt="currentUser.displayName" :src="currentUser.photoURL" />
                    </span>
                </template>
...
export default {
    ...
    computed: {
      //curentUser lấy từ user.js khi login thành công gán data user vào state.currentUser
        ...mapGetters({
