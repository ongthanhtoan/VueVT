...
<div>
    ...
    <b-row class="gallery gallery-page mb-5">
        <b-colxx xxs="6" lg="2" md="4" v-for="(thumb, thumbIndex) in thumbs1" :key="`thumb_${thumbIndex}`">
            <img class="img-fluid border-radius" :src="thumb" alt="thumbnail" @click="onThumbClick(thumbIndex,1)" />
        </b-colxx>
        <LightGallery :images="images1" :index="photoIndex1" :disable-scroll="true" @close="handleHide()" />
    </b-row>
    ...
    <b-row class="gallery gallery-page mb-5">
        <b-colxx xxs="6" lg="3" md="3" v-for="(thumb, thumbIndex) in thumbs2" :key="`thumb_${thumbIndex}`">
            <img class="img-fluid border-radius" :src="thumb" alt="thumbnail" @click="onThumbClick(thumbIndex,2)" />
        </b-colxx>
        <LightGallery :images="images2" :index="photoIndex2" :disable-scroll="true" @close="handleHide()" />
    </b-row>
</div>
</template>
